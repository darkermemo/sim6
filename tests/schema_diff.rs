...
mod tests {
    ...
    fn test_schema_diff_missing_in_db() {
        ...
        event_fields.insert("id".to_string(), RustField {
            name: "id".to_string(),
        ...
        event_fields.insert("timestamp".to_string(), RustField {
            name: "timestamp".to_string(),
        ...
        event_fields.insert("tenant_id".to_string(), RustField {
    ...
    fn test_schema_diff_type_mismatch() {
        ...
        event_fields.insert("count".to_string(), RustField {
            name: "count".to_string(),
    ...
    fn test_schema_diff_skip_field() {
        ...
        event_fields.insert("computed_field".to_string(), RustField {
    ...
    fn test_type_conversion() {
        ...
        assert_eq!(convert_clickhouse_to_rust("Nullable(Array(String))"), "Option<Vec<String>>");
    }
}