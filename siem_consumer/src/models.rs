    ...
    pub fn from_kafka_and_parsed_with_cim(
        ...
        Event {
            ...
            event_timestamp: parsed
                ...
                .unwrap_or(kafka_msg.event_timestamp),
            ingestion_timestamp: chrono::Utc::now().timestamp() as u32,
            source_ip: parsed
                .source_ip
                .clone()
                .unwrap_or_else(|| kafka_msg.source_ip.clone()),
            source_type,
            ...
            dest_ip: parsed.dest_ip.clone(),
            src_port: parsed.src_port,
            dest_port: parsed.dest_port,
            protocol: parsed
                .cim_protocol
                .clone()
                .or_else(|| parsed.protocol.clone()),
            ...
            parent_process: parsed.parent_process.clone(),
            ...
            registry_key: parsed.registry_key.clone(),
            registry_value: parsed.registry_value.clone(),
            url: parsed.url.clone(),
            uri_path: parsed.uri_path.clone(),
            uri_query: parsed.uri_query.clone(),
            http_method: parsed.http_method.clone(),
            http_status_code: parsed.http_status_code,
            http_user_agent: parsed.http_user_agent.clone(),
            http_referrer: parsed.http_referrer.clone(),
            ...
            threat_name: parsed.threat_name.clone(),
            threat_category: parsed.threat_category.clone(),
            severity: parsed
                .cim_severity
                .clone()
                .or_else(|| parsed.severity.clone()),
