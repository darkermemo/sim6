...
describe('VirtualizedTable', () => {
    it('renders with data', () => {
        render(_jsx(VirtualizedTable, { columns: mockColumns, data: mockData }));
    ...
    it('shows loading state', () => {
        render(_jsx(VirtualizedTable, { columns: mockColumns, data: [], loading: true }));
        expect(screen.getByText('Loading data...')).toBeInTheDocument();
    });
    it('shows error state', () => {
        const error = new Error('Failed to load data');
        render(_jsx(VirtualizedTable, { columns: mockColumns, data: [], error: error }));
        expect(screen.getByText('Error loading data')).toBeInTheDocument();
        expect(screen.getByText('Failed to load data')).toBeInTheDocument();
    });
    it('shows empty state', () => {
        render(_jsx(VirtualizedTable, { columns: mockColumns, data: [] }));
        expect(screen.getByText('No data available')).toBeInTheDocument();
    });
    it('handles row clicks', async () => {
        const onRowClick = jest.fn();
        const user = userEvent.setup();
        render(_jsx(VirtualizedTable, { columns: mockColumns, data: mockData, onRowClick: onRowClick }));
    ...
    it('handles selection when enabled', async () => {
        ...
        const user = userEvent.setup();
        render(_jsx(VirtualizedTable, { columns: mockColumns, data: mockData, enableSelection: true, onRowSelect: onRowSelect }));
    ...
    it('formats cell values correctly', () => {
        ...
        render(_jsx(VirtualizedTable, { columns: mockColumns, data: dataWithTimestamp }));
    ...
    it('handles sorting when enabled', async () => {
        const user = userEvent.setup();
        render(_jsx(VirtualizedTable, { columns: mockColumns, data: mockData, enableSorting: true }));
    ...
    it('applies custom className and style', () => {
        const { container } = render(_jsx(VirtualizedTable, { columns: mockColumns, data: mockData, className: "custom-table", style: { border: '2px solid red' } }));
    ...
    it('handles large datasets without performance issues', () => {
        ...
        render(_jsx(VirtualizedTable, { columns: mockColumns, data: largeData }));
