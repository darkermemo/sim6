...
// === MAIN COMPONENT ===
export function Chart({ option, width = '100%', height = 300, loading = false, loadingText = 'Loading chart...', error = null, theme = 'auto', className = '', onChartReady, onEvents = {}, style = {}, }) {
    ...
    // Show error state
    if (error) {
        return (_jsx("div", { className: `chart-error ${className}`, style: {
                width,
                height,
                display: 'flex',
                alignItems: 'center',
                ...
                ...style,
                    ...
                    padding: '20px'
                }, children: [_jsx("div", { style: { fontSize: '18px', marginBottom: '8px' }, children: "\u26A0\uFE0F" }), _jsx("div", { style: { fontSize: '14px', marginBottom: '4px' }, children: "Chart Error" }), _jsx("div", { style: { fontSize: '12px', opacity: 0.8 }, children: error.message })] }) }));
    }
    // Show empty state
    if (!option) {
        return (_jsx("div", { className: `chart-empty ${className}`, style: {
                width,
                height,
                display: 'flex',
                alignItems: 'center',
                ...
                ...style,
                    ...
                    padding: '20px'
                }, children: [_jsx("div", { style: { fontSize: '18px', marginBottom: '8px' }, children: "\uD83D\uDCCA" }), _jsx("div", { style: { fontSize: '14px' }, children: "No chart data" })] }) }));
    }
    return (_jsx("div", { ref: chartRef, className: `chart ${className}`, style: {
            width,
            height,
            ...style,
        } }));
...
export const ChartUtils = {
     ...
     */
    createTimelineOption: (buckets, title) => {
