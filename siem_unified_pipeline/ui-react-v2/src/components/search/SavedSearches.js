 ...
 */
export default function SavedSearches({ tenant, onSelect }) {
    ...
    const handlePin = async (searchId) => {
        try {
    ...
    const handleRename = async (id) => {
        ...
        try {
            ...
            setSearches(searches.map(s => s.saved_search_id === id ? { ...s, name: editName } : s));
            setEditingId(null);
        }
        catch (err) {
    ...
    return (_jsxs("div", { children: [_jsx("h4", { style: {
                    ...
                    fontSize: "0.875rem",
                    fontWeight: 600
                }, children: "Saved Searches" }), searches.length === 0 ? (_jsx("div", { className: "text-sm text-tertiary", style: { textAlign: "center", padding: "var(--space-lg)" }, children: "No saved searches yet" })) : (_jsx("div", { children: sortedSearches.map(search => {
                    ...
                    return (_jsxs("div", { style: {
                            ...
                            backgroundColor: isPinned ? "var(--bg-secondary)" : "var(--bg-primary)",
                                    ...
                                    marginBottom: "var(--space-xs)"
                                }, children: [_jsx("button", { onClick: () => handlePin(search.saved_search_id), style: {
                                            padding: "0.25rem",
                                            fontSize: "1rem",
                                        ...
                                        }, title: isPinned ? "Unpin" : "Pin to top", children: isPinned ? "⭐" : "☆" }), isEditing ? (_jsx("input", { value: editName, onChange: (e) => setEditName(e.target.value), onKeyDown: (e) => {
                                            if (e.key === "Enter")
                                                handleRename(search.saved_search_id);
                                            if (e.key === "Escape")
                                                setEditingId(null);
                                        }, onBlur: () => handleRename(search.saved_search_id), style: {
                                            flex: 1,
                                            padding: "0.25rem 0.5rem",
                                            fontSize: "0.875rem",
                                        }, autoFocus: true })) : (_jsx("div", { onClick: () => onSelect(search), style: {
                                            flex: 1,
                                            cursor: "pointer",
                                            fontSize: "0.875rem",
                                            fontWeight: 500,
                                        }, children: search.name })), _jsxs("div", { style: { display: "flex", gap: "var(--space-xs)" }, children: [_jsx("button", { onClick: () => {
                                                ...
                                                }, title: "Rename", children: "\u270F\uFE0F" }), _jsx("button", { onClick: () => handleDelete(search.saved_search_id), style: {
                                                    padding: "0.25rem",
                                                    fontSize: "0.75rem",
                                                    backgroundColor: "transparent",
                                                    border: "none",
                                                ...
                                                }, title: "Delete", children: "\uD83D\uDDD1\uFE0F" })] })] }), _jsx("div", { style: {
                                    fontSize: "0.75rem",
                                    color: "var(--text-tertiary)",
                                    marginLeft: "calc(1rem + var(--space-sm))"
                                }, children: _jsx("code", { children: search.q }) }), _jsxs("div", { style: {
                                    fontSize: "0.75rem",
                                    color: "var(--text-tertiary)",
                                    marginTop: "var(--space-xs)",
                                    marginLeft: "calc(1rem + var(--space-sm))"
                                }, children: ["Updated ", formatDate(search.updated_at), search.shared_with && search.shared_with.length > 0 && (_jsxs("span", { children: [" \u2022 Shared with ", search.shared_with.length] }))] })] }, search.saved_search_id));
                }) }))] }));
}
